...
<html lang="en">
  <head>
    ...
    <title>Products from ${category.nombre}</title>
  ...
  <body>
    <div class="container">
      ...
      <p class="title" style="font-weight: bold">
        <a class="categories-link" href="/categories">Categories</a> >
        ${category.nombre} products
      </p>
      <div class="image-column">
        <c:forEach
          items="${productosDeLaCategoria}"
          var="producto"
          varStatus="status"
        >
      ...
      <div class="pagination justify-content-center">
        <ul class="pagination">
          <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
            <a
              class="page-link"
              href="/categories/${category.id}?page=${currentPage - 1}"
              aria-label="Previous"
            >
          ...
          <c:forEach begin="1" end="${totalPages}" var="pageNumber">
            <li class="page-item ${currentPage == pageNumber ? 'active' : ''}">
              <a
                class="page-link"
                href="/categories/${category.id}?page=${pageNumber}"
                >${pageNumber}</a
              >
            </li>
          </c:forEach>
